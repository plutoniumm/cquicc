...
<svg src="Wikimedia Commons" alt="Drawing a line between 2 classes" xmlns="http://www.w3.org/2000/svg" stroke="none" stroke-linecap="round" stroke-linejoin="round" viewbox="0 0 232 166" height="139" width="200">
    <g transform="translate(-212 -169)">
        ...
        <path d="m212 183 4-12 5 12c-3-2-7-2-9 0z"></path><text x="230" y="177" font-size="15">
            <tspan x="230" y="177">y</tspan>
            <tspan x="436" y="336">x</tspan>
        </text>
        <g fill="#3139ae">
            <path d="M345 273a4 4 0 1 1-7-2 4 4 0 0 1 7 2z"></path>
            <path d="M308 298a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
            <path d="M303 278a4 4 0 1 1-8-2 4 4 0 0 1 8 2z"></path>
            <path d="M369 287a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
            <path d="M337 296a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
            <path d="M327 284a4 4 0 1 1-9 0 4 4 0 0 1 9 0z"></path>
            <path d="M360 304a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
            <path d="M387 305a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
            <path d="M387 275a4 4 0 1 1-8 0 4 4 0 0 1 8 0z"></path>
        </g>
        <g fill="#dd2a2b">
            <path d="M296 193h7v7h-7v-7z"></path>
            <path d="M324 219h7v7h-7v-7z"></path>
            <path d="M317 188h7v7h-7v-7z"></path>
            <path d="M295 210h6v7h-6v-7z"></path>
            <path d="M273 192h7v7h-7v-7z"></path>
            <path d="m264 226 7-1v7h-7v-6z"></path>
            <path d="M250 209h7v7h-7v-7z"></path>
            <path d="M342 191h7v7h-7v-7z"></path>
        </g>
...
## Optimizations
The following solutions will all work only under the assumption that we're rewriting the QSVM
...
### Simulations
It is worth using a NoiseModel based simulator to see how close the results are to the Quantum Computer for small datasets. This will give us data
/===
===

on what the final results are expected to look like.
