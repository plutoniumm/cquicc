...
InjhQpT::hartree fock,hydrogen,chart,cut, combined`;function z(o,t,n){const r=o.slice();return r[8]=t[n],r}function C(o){let t,n,r,e,i,h=o[8][0]+"",f,l;return{c(){t=y("div"),n=y("img"),e=A(),i=y("div"),f=j(h),l=A(),this.h()},l(c){t=w(c,"DIV",{class:!0});var s=k(t);n=w(s,"IMG",{class:!0,src:!0,alt:!0}),e=I(s),i=w(s,"DIV",{class:!0});var a=k(i);f=B(a,h),a.forEach(p),l=I(s),s.forEach(p),this.h()},h(){d(n,"class","rx5 ptr svelte-i1tc4w"),F(n.src,r=o[8][1])||d(n,"src",r),d(n,"alt",o[8][0]),d(i,"class","p5 tc link svelte-i1tc4w"),d(t,"class","p5")},m(c,s){_(c,t,s),g(t,n),g(t,e),g(t,i),g(i,f),g(t,l)},p:T,d(c){c&&p(t)}}}function G(o){let t=o[2](o[0],o[8][0]),n,r=t&&C(o);return{c(){r&&r.c(),n=L()},l(e){r&&r.l(e),n=L()},m(e,i){r&&r.m(e,i),_(e,n,i)},p(e,i){i&5&&(t=e[2](e[0],e[8][0])),t?r?r.p(e,i):(r=C(e),r.c(),r.m(n.parentNode,n)):r&&(r.d(1),r=null)},d(e){e&&p(n),r&&r.d(e)}}}function Y(o){let t,n,r,e,i,h,f=D(o[3]),l=[];for(let c=0;c<f.length;c+=1)l[c]=G(z(o,f,c));return{c(){t=y("div"),n=y("input"),r=A(),e=y("div");for(let c=0;c<l.length;c+=1)l[c].c();this.h()},l(c){t=w(c,"DIV",{id:!0,class:!0,style:!0});var s=k(t);n=w(s,"INPUT",{type:!0,placeholder:!0,class:!0}),s.forEach(p),r=I(c),e=w(c,"DIV",{class:!0,style:!0});var a=k(e);for(let u=0;u<l.length;u+=1)l[u].l(a);a.forEach(p),this.h()},h(){d(n,"type","text"),d(n,"placeholder","Search"),d(n,"class","rx5 p10 d-b mx-a w-50 svelte-i1tc4w"),d(t,"id","search"),d(t,"class","p5 m5 p-fix svelte-i1tc4w"),b(t,"background","#fff"),b(t,"top","-5px"),b(t,"z-index","1"),d(e,"class","f j-ar fw"),b(e,"z-index","0"),b(e,"padding-top","100px")},m(c,s){_(c,t,s),g(t,n),q(n,o[0]),o[6](n),_(c,r,s),_(c,e,s);for(let a=0;a<l.length;a+=1)l[a]&&l[a].m(e,null);i||(h=[E(window,"keyup",o[4]),E(n,"input",o[5]),E(e,"click",O)],i=!0)},p(c,[s]){if(s&1&&n.value!==c[0]&&q(n,c[0]),s&13){f=D(c[3]);let a;for(a=0;a<f.length;a+=1){const u=z(c,f,a);l[a]?l[a].p(u,s):(l[a]=G(u),l[a].c(),l[a].m(e,null))}for(;a<l.length;a+=1)l[a].d(1);l.length=f.length}},i:T,o:T,d(c){c&&(p(t),p(r),p(e)),o[6](null),S(l,c),i=!1,U(h)}}}function O({target:o}){o.tagName==="IMG"&&navigator.clipboard.writeText(o.src)}function X(o,t,n){let r,e,i="";const h=new m(K.split(`
`)).filter(Boolean).map(a=>{let[u,v]=a.split("::");return u.includes("i.imgur")||(u=`https://i.imgur.com/${u}.png`),[v||u,u]}).collect();function f(a){return a.toLowerCase()}function l({key:a}){if(document.activeElement.tagName!=="INPUT")return a==="/"&&e.focus(),!0}function c(){i=this.value,n(0,i)}function s(a){V[a?"unshift":"push"](()=>{e=a,n(1,e)})}return n(2,r=(a,u)=>{if(a.length<2)return!0;u=f(u),a=f(a).replaceAll(" ",",").split(",");for(let v=0;v<a.length;v++)if(u.includes(a[v]))return!0;return!1}),[i,e,r,h,l,c,s]}class W extends N{constructor(t){super(),P(this,t,X,Y,H,{})}}export{W as component};
